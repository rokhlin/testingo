...
public class WebImageView extends ImageView {
	...
	public static final String ACTION_INVALID_BUNDLE_URL = "com.com.yelp.android.webimageview.intent.invalid_bundle_url";
	...
	public static class WebImageLoaderHandler extends ImageLoaderHandler {
		...
		public WebImageLoaderHandler(String url, WebImageView view,
			...
			mUrl = url;
			mCallback = new WeakReference<ImageLoadedCallback>(callback);

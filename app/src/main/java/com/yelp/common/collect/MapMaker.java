...
/**
 * A {@link java.util.concurrent.ConcurrentMap} builder, providing any combination of these features:
 * {@linkplain java.lang.ref.SoftReference soft} or {@linkplain java.lang.ref.WeakReference weak} keys, soft
 ...
 * valid concurrent map that behaves exactly like a {@link java.util.concurrent.ConcurrentHashMap}.
 * The returned map is implemented as a hash table with similar performance
 * characteristics to {@link java.util.concurrent.ConcurrentHashMap}. It supports all optional
 ...
 * from the map's {@linkplain java.util.Map#entrySet() entry set} is snapshot of that
...
public final class MapMaker {
     ...
     * in a {@link java.lang.ref.WeakReference} (by default, strong references are used).
     * <p>
    ...
    /**
     * Specifies that each key (not value) stored in the map should be wrapped
     * in a {@link java.lang.ref.SoftReference} (by default, strong references are used).
     * <p>
     * <b>Note:</b> the map will use identity ({@code ==}) comparison to
     ...
     * of {@link java.util.Map#containsValue(Object) containsValue},
     * {@link java.util.concurrent.ConcurrentMap#remove(Object, Object) remove(Object, Object)}, and
     * {@link java.util.concurrent.ConcurrentMap#replace(Object, Object, Object) replace(K, V, V)}.
     * 
     * @throws IllegalStateException
     *         if the key strength was already set
     * @see java.lang.ref.WeakReference
     ...
     * {@link java.util.Map#get} either returns an already-computed value for the given
     ...
     * completes.
     * <p>
     * {@link java.util.Map#get} on the returned map will never return {@code null}. It
     * may throw:
     * <ul>
     ...
     * stored in the map.
     * <p>
     * If {@link java.util.Map#put} is called before a computation completes, other

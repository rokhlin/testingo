 ...
 * any methods. Use {@link com.yelp.common.collect.CustomConcurrentHashMap.Builder} to create a custom concurrent hash map
 * instance. Client libraries implement {@link com.yelp.common.collect.CustomConcurrentHashMap.Strategy}, and this class
 * provides the surrounding concurrent data structure which implements
 * {@link java.util.concurrent.ConcurrentMap}. Additionally supports implementing maps where
 * {@link java.util.Map#get} atomically computes values on demand (see
 * {@link com.yelp.common.collect.CustomConcurrentHashMap.Builder#buildComputingMap(com.yelp.common.collect.CustomConcurrentHashMap.ComputingStrategy, Function)}
 * ).
 * <p>
 ...
 * all access.
 * <p>
 * Retrieval operations (including {@link java.util.Map#get}) generally do not block, so
 * may overlap with update operations (including {@link java.util.Map#put} and
 * {@link java.util.Map#remove}). Retrievals reflect the results of the most recently
 * <i>completed</i> update operations holding upon their onset. For aggregate
 * operations such as {@link java.util.Map#putAll} and {@link java.util.Map#clear}, concurrent
 ...
 * <p>
 * The resulting {@link java.util.concurrent.ConcurrentMap} and its views and iterators implement all
...
final class CustomConcurrentHashMap {
    ...
    static final class Builder {
        ...
        /**
         * Creates a {@link java.util.concurrent.ConcurrentMap}, backed by the given strategy, that
         * supports atomic, on-demand computation of values. {@link java.util.Map#get}
         ...
         * <p>
         * {@link java.util.Map#get} in the returned map implementation throws:
         * <ul>
     ...
     * reclaimed entries so that {@link java.util.Map#isEmpty} and {@link java.util.Map#size()}
    ...
    public interface Strategy<K, V, E> {
         ...
         * that was provided to {@link com.yelp.common.collect.CustomConcurrentHashMap.Strategy#newEntry} when the given entry
         * was created.
         * 
         * @return the next entry or null if null was passed to
         *         {@link com.yelp.common.collect.CustomConcurrentHashMap.Strategy#newEntry}
         */
        E getNext(E entry);

        /**
         * Returns the hash code that was passed to {@link com.yelp.common.collect.CustomConcurrentHashMap.Strategy#newEntry})
    ...
    /**
     * Extends {@link com.yelp.common.collect.CustomConcurrentHashMap.Strategy} to add support for computing values on-demand.
     ...
     * 
     * @see com.yelp.common.collect.CustomConcurrentHashMap.Builder#buildComputingMap(com.yelp.common.collect.CustomConcurrentHashMap.ComputingStrategy,
     *      Function)
     */
    public interface ComputingStrategy<K, V, E> extends Strategy<K, V, E> {
         ...
         * Called as a result of {@link java.util.Map#get}. If this method throws an
         ...
         *        that was created
         * @param computer
         *        passed to {@link com.yelp.common.collect.CustomConcurrentHashMap.Builder#buildMap}
     ...
     * {@link com.yelp.common.collect.CustomConcurrentHashMap.SimpleInternalEntry}. Intended to be subclassed to provide
    ...
    /**
     * A basic, no-frills entry class used by {@link com.yelp.common.collect.CustomConcurrentHashMap.SimpleInternalEntry}.
     */
